...
mod.controller('PhekbDashboardController', ['$scope', 'security', '$http', '$rootScope', '$cookies', 'LibraryService',function($scope, security, $http, $rootScope, $cookies, LibraryService) {
